...
// ⚠️ Бүхээгний ЭД АНГИ (хаалга, хүрээ) нь бүхээг БИШ. Эс тэгвэл бүхээг зарахад
// складаас "Жорлон бүхээгний хаалга" хасагддаг байсан (эхэлж таарсан мөрийг авдаг).
const isCab = s => /бүхээг/.test(s) && !/хаалга|хүрээ/.test(s);
